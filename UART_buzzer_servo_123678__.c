...
void PortInit()
{
   P1SEL |= 0x03;              //Timer1通道2映射至P1_0，功能選擇
  //Timer通道?置
...
void InitT3()
{  
  P1SEL |=0x40;   //外設功能 P1_6
  PERCFG |=0x20;  //開啟timer3位置2
